...
export async function GetNextPokemon (url:string, pokemon:PokemonArray, refDiv:React.RefObject<HTMLDivElement>, refButton:React.RefObject<HTMLButtonElement>, divFemale:React.RefObject<HTMLDivElement>) {
