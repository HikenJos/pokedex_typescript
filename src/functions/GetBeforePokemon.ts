...
export async function GetBeforePokemon (url:string, pokemon:PokemonArray, refDiv:React.RefObject<HTMLDivElement>, refLabel:React.RefObject<HTMLLabelElement>) {
